...
<body>
    ...
    <div class="content">
        <div id="pilihan">
            <a href="riwayat-pengajuan.php" class="text-black" id="pengajuan">Pengajuan Saya</a>
        ...
        <div class="rectangle">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM user JOIN member ON user.id_user = member.id_user JOIN pengajuan ON pengajuan.id_user = user.id_user WHERE user.id_user = ? AND pengajuan.status = 'DiSetuju' ORDER BY pengajuan.tglaju DESC";
