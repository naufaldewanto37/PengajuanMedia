...
<head>
    ...
    <link rel="stylesheet" href="../style/style-tambah-tolak.css">
...
<body>
    ...
    <div id="text">
        <p class="text">Mohon Maaf, Pengajuan Anda Belum Bisa Kami Terima </p>
        <p class="text">Dengan Alasan :</p>
        <p class="text"><?php echo $alasan; ?></p>
        <P class="text">Terima Kasih Telah Mengisi Form Pengajuan Kerjasama Media. Silahkan Mengajukan Kembali di Lain Waktu. </p>
    </div>
</body>
